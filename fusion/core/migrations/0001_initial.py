    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni-mobile', 'Mobile'), ('lni-cog', 'Engrenagem'), ('lni-users', 'Usuários'), ('lni-layers', 'Design'), ('lni-stats-up', 'Gráfico'), ('lni-rocket', 'Foguete')], max_length=12, verbose_name='Icone')),
            ],
            options={
